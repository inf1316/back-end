...
{
    public class UpdateCarAdCommandValidator : AbstractValidator<UpdateCarAdCommand>
    {
        public UpdateCarAdCommandValidator()
        {
            ...
            RuleFor(v => v.ModelVersion)
                .MaximumLength(50)
                .WithMessage("The version cannot be more than 50 characters.");

            RuleFor(model => model.Price)
                .GreaterThanOrEqualTo(100)
                .WithMessage("The price can't be that small.");
