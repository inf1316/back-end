...
{
    public record GetCarAdByIdQueryResponse
    {
        ...
        public CarAdByIdCoordinateQueryResponse? ContactLocation { get; init; }

        public BaseItemByIdQueryResponse[] ExteriorTypes { get; init; } = Array.Empty<BaseItemByIdQueryResponse>();
        public BaseItemByIdQueryResponse[] SafetyTypes { get; init; } = Array.Empty<BaseItemByIdQueryResponse>();
        public BaseItemByIdQueryResponse[] InsideTypes { get; init; } = Array.Empty<BaseItemByIdQueryResponse>();

        public string[] Images { get; init; } = Array.Empty<string>();
    }

    public record BaseItemByIdQueryResponse 
    {
        public int Id { get; init; }
        public string Name { get; init; } = string.Empty;
    }

    public record CarAdByIdCoordinateQueryResponse
    {
