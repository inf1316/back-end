...
{
    public record AdPublishedDomainEvent : IDomainEvent
    {
        ...
        public static AdPublishedDomainEvent FromCarAd(CarAd ad)
        {
            ...
            var images = ad.Images.Select(x => new ImageDto(x.FileName)).ToArray();

            return new AdPublishedDomainEvent
                (
                    ad.Id,
                    ad.UserId,
                    ad.CreatedAt,
